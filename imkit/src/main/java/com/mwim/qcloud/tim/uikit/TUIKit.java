...
public class TUIKit {
     ...
     */
    protected static void init(Context context, int sdkAppID, TUIKitConfigs configs) {
     ...
     * @param listener
     */
    protected static void addIMEventListener(IMEventListener listener) {
     ...
     */
    protected static void removeIMEventListener(IMEventListener listener) {
     ...
     */
    protected static void login(String userid, String usersig, final IUIKitCallBack callback) {
        TUIKitImpl.login(userid, usersig, callback);
    }

    protected static void logout(final IUIKitCallBack callback) {
